...
const GameViewer = ({ folder, onClose, onBackToStudy }) => {
    ...
    const [gameState, setGameState] = useState('starting'); // starting, asking, listening, scoring, round_result, game_over
    ...
    useEffect(() => {
        if (gameState === 'starting') {
            // A brief moment to show the start screen
    ...
    return (
        <div className="viewer-overlay game-mode">
            <div className="game-header">
                ...
                <button onClick={() => onBackToStudy(folder)} className="viewer-close-btn">&times;</button>
            </div>
